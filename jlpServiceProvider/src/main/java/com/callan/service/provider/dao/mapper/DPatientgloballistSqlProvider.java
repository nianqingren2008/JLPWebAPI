...
public class DPatientgloballistSqlProvider {

    public String insertSelective(DPatientgloballist record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("D_PATIENTGLOBALLIST");
        ...
        if (record.getPatientid() != null) {
            sql.VALUES("PATIENTID", "#{patientid,jdbcType=DECIMAL}");
        }
    ...
    public String updateByPrimaryKeySelective(DPatientgloballist record) {
        SQL sql = new SQL();
        sql.UPDATE("D_PATIENTGLOBALLIST");
        ...
        if (record.getPatientid() != null) {
            sql.SET("PATIENTID = #{patientid,jdbcType=DECIMAL}");
        }
