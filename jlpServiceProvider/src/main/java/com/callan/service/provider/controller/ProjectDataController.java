...
public class ProjectDataController {
	...
	public String Delete(@RequestBody ProjectDataModel projectData, HttpServletRequest request,
		...
		for (Long dataId : dataids) {
			List<JProjectdeldata> list = projectDeldataService.getByProjectIdAndTableId(projectData.getProjectId(),
		...
		Set<Long> projectdeldatasIds = new HashSet<Long>();
		...
		for(Long dataId : dataids) {
			if (!projectdeldatasIds.contains(dataId)) {
