...
public class DPatientglobalSqlProvider {

    public String insertSelective(DPatientglobal record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("D_PATIENTGLOBAL");
    ...
    public String updateByPrimaryKeySelective(DPatientglobal record) {
        SQL sql = new SQL();
        sql.UPDATE("D_PATIENTGLOBAL");
